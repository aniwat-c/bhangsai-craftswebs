        ...
        <div className="max-w-[1400px] mx-auto px-8 md:px-16">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2 space-y-8">
              <span className="text-[#C29958] font-bold tracking-[0.3em] uppercase text-sm block">Established 1980</span>
              <h2 className="text-5xl md:text-6xl font-serif leading-tight text-[#332D29]">
                จุดกำเนิดแห่ง <br /> <span className="italic text-[#C29958]">พระมหากรุณาธิคุณ</span>
              </h2>
              <div className="space-y-6 text-[#5A524D] text-lg leading-relaxed">
                <p>
                  ก่อตั้งขึ้นเมื่อวันที่ 7 ธันวาคม พ.ศ. 2523 โดยสมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ พระบรมราชชนนีพันปีหลวง เพื่อเป็นอาชีพเสริมและยกระดับคุณภาพชีวิตราษฎร
                </p>
                <p className="border-l-4 border-[#C29958] pl-6 italic">
                  "ทรงต้องการให้ชาวบ้านมีวิชาติดตัว เพื่ออนุรักษ์งานช่างฝีมือไทยที่กำลังจะสูญหายให้คงอยู่สืบไป"
                </p>
              </div>
            </div>
            <div className="lg:w-1/2 relative">
              <div className="aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl grayscale hover:grayscale-0 transition-all duration-1000">
                <img src="/img/history-bangsai.jpg" alt="Bangsai History" className="w-full h-full object-cover" />
              </div>
              {/* ตกแต่งด้วยกรอบทองจางๆ */}
              <div className="absolute -bottom-6 -right-6 w-full h-full border-2 border-[#C29958]/20 rounded-3xl -z-10"></div>
            </div>
          </div>
        </div>
      </section>
            ...
            {/* Highlights Section */}
      <section className="py-32 bg-[#332D29] text-white overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-8 md:px-16">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-serif mb-6 italic text-[#C29958]">Explore the Center</h2>
            <p className="text-stone-400 tracking-widest uppercase text-xs">จุดไฮไลต์สำคัญภายในศูนย์ศิลปาชีพบางไทร</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="group cursor-pointer">
              <div className="relative h-80 rounded-2xl overflow-hidden mb-6">
                <img src="/img/sala-pamingkhwan.jpg" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all"></div>
              </div>
              <h4 className="text-2xl font-serif mb-3 text-[#C29958]">ศาลาพระมิ่งขวัญ</h4>
              <p className="text-stone-400 text-sm leading-relaxed">อาคารทรงไทยประยุกต์ขนาดใหญ่ ศูนย์รวมนิทรรศการมาสเตอร์พีซและร้านจำหน่ายผลิตภัณฑ์ระดับโลก</p>
            </div>

            {/* Highlight 2 */}
            <div className="group cursor-pointer">
              <div className="relative h-80 rounded-2xl overflow-hidden mb-6">
                <img src="/img/village-life.jpg" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all"></div>
              </div>
              <h4 className="text-2xl font-serif mb-3 text-[#C29958]">หมู่บ้านอาชีพเกษตรกรรม</h4>
              <p className="text-stone-400 text-sm leading-relaxed">จำลองวิถีชีวิตชาวไทยในภูมิภาคต่างๆ สัมผัสบรรยากาศความเป็นอยู่ที่สะท้อนถึงวัฒนธรรมท้องถิ่น</p>
            </div>

            {/* Highlight 3 */}
            <div className="group cursor-pointer">
              <div className="relative h-80 rounded-2xl overflow-hidden mb-6">
                <img src="/img/nature-park.jpg" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-all"></div>
              </div>
              <h4 className="text-2xl font-serif mb-3 text-[#C29958]">สวนนกและสถานแสดงพันธุ์สัตว์น้ำ</h4>
              <p className="text-stone-400 text-sm leading-relaxed">พื้นที่พักผ่อนหย่อนใจริมแม่น้ำเจ้าพระยา เหมาะสำหรับการเรียนรู้ธรรมชาติสำหรับครอบครัว</p>
            </div>
          </div>
        </div>
      </section>
